...
public class JFrameRecord extends javax.swing.JFrame {
    ...
    private void jButtonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertActionPerformed
        try {
            ...
            record.setDateRecord(ConvertUtils.localDateToDate(datePicker1.getDate()));
    ...
    private void jTableRecordsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableRecordsMouseClicked
        ...
        {   
            try {
                ...
                datePicker1.setDate(ConvertUtils.dateToLocalDate(myRecord.getDateRecord()));
                ...
                timePickerEnd.setText(myRecord.getEndTime() != null ? 
                                        ConvertUtils.timeToString(myRecord.getEndTime()) :  null);
                timePickerStart.setText(ConvertUtils.timeToString(myRecord.getStartTime()));
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        try {
            ...
            record.setEndTime( timePickerEnd.getTime() != null ?   
                               ConvertUtils.localTimeToDate(timePickerEnd.getTime()) : null );            
            //FK
            Employee employee = (Employee) jComboBoxEmployee.getSelectedItem();
            record.setEmployeeId(employee);
            KeyRoom key = (KeyRoom) jComboBoxKeys.getSelectedItem();
